resource "aws_iam_role" "ecs_task_execution_role" {
  name = "${var.project_prefix}-${var.env}-ecs-task-execution-role"
...
resource "aws_iam_role" "ecs_task_role" {
  name = "${var.project_prefix}-${var.env}-ecs-task-role"
...
resource "aws_iam_role" "ecs_auto_scale_role" {
  name               = "${var.project_prefix}-${var.env}-ecs-autoscale-role"
